  ...
  <div class="footer-wrapper">
    ...
    >
      <path
        fill-rule="evenodd"
        clip-rule="evenodd"
        d="M0 80.8632L29 57.1813C58 33.4995 117 -13.8643 175 3.89712C233 21.6585 292 104.545 350 116.386C408 128.227 467 69.0223 525 74.9427C583 80.8632 642 151.909 700 181.511C758 211.113 817 199.273 875 157.829C933 116.386 992 45.3404 1050 33.4995C1108 21.6585 1167 69.0223 1225 74.9427C1283 80.8632 1342 45.3404 1371 27.579L1400 9.81759V294H0V80.8632Z"
        fill="#2849AB"
      />
    </svg>
    ...
    <div class="footer-text">
      ...
      <div>This app uses Spotify API but is not affiliated with Spotify.</div>
    </div>
  </div>
</template>
